...
<div class="prev-article row">
    <div class="blog-prev-date col-md-3 col-sm-3">        
        ...
        <span class="info hidden-xs">
            <span class="block"><i class="fa fa-folder-open-o"></i> POSTED IN <?php echo CHtml::link(ContentCategory::getCategoryName($data->catid), array('news/upozila', 'id' => $data->catid), array('class' => '')); ?></span>
